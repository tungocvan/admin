<div>
    ...
    <div class="mb-6 border-b border-gray-200">
        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            ...
            <button wire:click="setType('menu')"
                class="{{ $type === 'menu' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium transition-colors flex items-center gap-2">
                <span>📝</span> Danh mục Menu
            </button>
        </nav>
    </div>
                            ...
                            @foreach ($child->children as $grandChild)
                                <tr class="bg-white hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-2 text-right text-xs font-medium">
                                        <a href="{{ route('admin.category.edit', $grandChild->id) }}"
                                            class="text-indigo-600 hover:text-indigo-900 mr-2">Sửa</a>
